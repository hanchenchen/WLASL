...
def run(configs,
    ...
    supervised_cue = cue + ['late_fusion', 'msa_fuse'] + [f'local_align/{i}' for i in cue] + ['local_glocal_fusion']
...
if __name__ == '__main__':
    ...
    save_model = f'logdir/train_{root["train"][0]}/1207-103-fuse-msa-head-88'
