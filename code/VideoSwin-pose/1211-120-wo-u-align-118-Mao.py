...
def run(configs,
    ...
    dataset = Dataset('train', root, train_transforms, num_classes=51)
    ...
    supervised_cue = cue + ['late_fusion', 'local_align/multimodal'] + ['local_glocal_fusion']
...
if __name__ == '__main__':
    ...
    save_model = f'logdir/train_{root["train"][0]}/1211-120-wo-u-align-118-Mao'
