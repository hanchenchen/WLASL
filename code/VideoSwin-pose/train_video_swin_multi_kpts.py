...
# from datasets.nslt_dataset import NSLT as Dataset
from datasets.capg_csl_dataset_sample_sepa_multi_kpts_branch import CAPG_CSL as Dataset
import seaborn as sns
import pandas as pd
import matplotlib.pyplot as plt
from MultiCueModel_multi_kpts import MultiCueModel
...
def run(configs,
    ...
    cue = ['full_rgb', 'right_hand', 'left_hand', 'face', 'frame_kpts', 'face_kpts', 'right_hand_kpts', 'left_hand_kpts']
    ...
    while steps < configs.max_steps and epoch < max_epoch:  # for epoch in range(num_epochs):
        ...
        for phase in phase_list:
            ...
            for data in dataloaders[phase]:
                ...
                full_rgb, labels, vid, right_hand, left_hand, face, frame_kpts, face_kpts, right_hand_kpts, left_hand_kpts = data
...
if __name__ == '__main__':
    ...
    save_model = f'logdir/train_{root["train"][0]}/1202-75-multi-kpts-branch-74'
